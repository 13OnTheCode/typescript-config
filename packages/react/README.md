# @13onthecode/typescript-config-react
...
[![Version](https://img.shields.io/npm/v/@13onthecode/typescript-config-react?color=1976d2&label=)](https://www.npmjs.com/package/@13onthecode/typescript-config-react)
[![License](https://img.shields.io/npm/l/@13onthecode/typescript-config-react?color=1976d2&label=)](LICENSE.md)
...
```bash
npm install @13onthecode/typescript-config-react --save-dev
```
